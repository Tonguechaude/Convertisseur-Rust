...
fn test_octal_to_binary()
{
    ...
    assert_eq!(convertisseur::octal_to_binary(1122021), "1001010010000010001");
...
fn test_decimal_to_binary ()
{
    ...
    assert_eq!(convertisseur::decimal_to_binary(101010101010), "1011110000100101010111101001100010010");
...
fn test_decimal_to_octal ()
{
    ...
    assert_eq!(convertisseur::decimal_to_octal(101010101010), "1360452751422");
...
fn test_decimal_to_hexadecimal ()
{
    ...
    assert_eq!(convertisseur::decimal_to_hexadecimal(101010101010), "1784ABD312");
...
{
    assert_eq!(convertisseur::hexadecimal_to_binary("FFFFFF"), "111111111111111111111111");
    assert_eq!(convertisseur::hexadecimal_to_binary("ABCD"), "1010101111001101");
    assert_eq!(convertisseur::hexadecimal_to_binary("A521"), "1010010100100001");
}
